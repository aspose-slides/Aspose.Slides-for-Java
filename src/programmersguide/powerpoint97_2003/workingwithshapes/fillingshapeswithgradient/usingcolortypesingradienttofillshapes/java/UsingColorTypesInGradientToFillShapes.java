...
package programmersguide.powerpoint97_2003.workingwithshapes.fillingshapeswithgradient.usingcolortypesingradienttofillshapes.java;

import com.aspose.slides.*;

public class UsingColorTypesInGradientToFillShapes
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/powerpoint97_2003/workingwithshapes/fillingshapeswithgradient/usingcolortypesingradienttofillshapes/data/";
