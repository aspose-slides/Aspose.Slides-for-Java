...
package programmersguide.powerpoint97_2003.workingwithshapes.fillingshapeswithgradient.adjustinggradientfillangle.java;

import com.aspose.slides.*;

public class AdjustingGradientFillAngle
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/powerpoint97_2003/workingwithshapes/fillingshapeswithgradient/adjustinggradientfillangle/data/";
