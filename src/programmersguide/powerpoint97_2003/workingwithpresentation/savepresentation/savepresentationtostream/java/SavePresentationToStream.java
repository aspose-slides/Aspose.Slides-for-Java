...
package programmersguide.powerpoint97_2003.workingwithpresentation.savepresentation.savepresentationtostream.java;
...
public class SavePresentationToStream
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/powerpoint97_2003/workingwithpresentation/savepresentation/savepresentationtostream/data/";
        ...
        rect.addTextFrame("Sample Presentation to depict " + eol +
        ...
        try
        {
            FileOutputStream outStream = new FileOutputStream(dataDir + "output.ppt");
