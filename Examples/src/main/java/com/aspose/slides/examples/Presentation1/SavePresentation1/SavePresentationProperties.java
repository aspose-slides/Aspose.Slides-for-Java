...
package com.aspose.slides.examples.Presentation1.SavePresentation1;

import com.aspose.slides.*;
import com.aspose.slides.examples.Utils;

public class SavePresentationProperties
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = Utils.getDataDir(SavePresentationProperties.class);
