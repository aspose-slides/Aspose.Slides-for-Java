...
package com.aspose.slides.examples.Presentation1.PresentationToTIFF1;
...
public class CustomSize
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = Utils.getDataDir(CustomSize.class);
        ...
        //Save the Presentation1 to TIFF with specified image size
