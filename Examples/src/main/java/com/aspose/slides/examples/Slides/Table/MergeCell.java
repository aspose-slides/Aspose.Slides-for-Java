...
public class MergeCell {
	...
	//ExStart:MergeCell
		...
		String dataDir = Utils.getDataDir(MergeCell.class);
                ...
                tbl.mergeCells(tbl.getRows().get_Item(1).get_Item(1), tbl.getRows().get_Item(1).get_Item(2), false);

                pres.save(dataDir + "MergeCells1_out.pptx", SaveFormat.Pptx);
