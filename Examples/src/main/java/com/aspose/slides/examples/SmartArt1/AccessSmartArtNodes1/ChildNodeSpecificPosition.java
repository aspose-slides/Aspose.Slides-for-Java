...
package com.aspose.slides.examples.SmartArt1.AccessSmartArtNodes1;
...
public class ChildNodeSpecificPosition
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir =  Utils.getDataDir(ChildNodeSpecificPosition.class);

        //Instantiate the Presentation1
