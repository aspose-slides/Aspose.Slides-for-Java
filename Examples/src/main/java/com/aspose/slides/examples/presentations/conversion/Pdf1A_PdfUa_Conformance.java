...
public class Pdf1A_PdfUa_Conformance
{
    public static void main(String[] args)
    {
        ...
        String outPdf1aFile = RunExamples.OutPath + "tagged-pdf-demo_1a.pdf";
        String outPdf1bFile = RunExamples.OutPath + "tagged-pdf-demo_1b.pdf";
        String outPdfUaFile = RunExamples.OutPath + "tagged-pdf-demo_1ua.pdf";
