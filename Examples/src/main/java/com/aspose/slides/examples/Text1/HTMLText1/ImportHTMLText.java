...
package com.aspose.slides.examples.Text1.HTMLText1;
...
public class ImportHTMLText
{
    public static void main(String[] args) throws Exception {
        ...
        String dataDir = Utils.getDataDir(ImportHTMLText.class);

        //Create Empty Presentation1 instance//Create Empty Presentation1 instance
        ...
        //Adding Text1 frame to the shape
        ashape.addTextFrame("");

        //Clearing all paragraphs in added Text1 frame
        ...
        //Adding Text1 from HTML stream reader in Text1 frame
