...
package asposefeatures.workingwithmediacontrols.addingaudioframe.java;
...
public class AsposeAudioFrame
{
    ...
    {
	String dataPath = "src/asposefeatures/workingwithmediacontrols/addingaudioframe/data/";
