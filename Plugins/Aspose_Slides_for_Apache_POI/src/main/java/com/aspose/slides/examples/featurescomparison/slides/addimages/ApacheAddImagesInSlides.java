package com.aspose.slides.examples.featurescomparison.slides.addimages;
...
public class ApacheAddImagesInSlides
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = Utils.getDataDir(ApacheAddImagesInSlides.class);
        ...
        FileOutputStream out = new FileOutputStream(dataDir + "ImageInSlides_Apache_Out.ppt");
        ppt.write(out);
        out.close();
