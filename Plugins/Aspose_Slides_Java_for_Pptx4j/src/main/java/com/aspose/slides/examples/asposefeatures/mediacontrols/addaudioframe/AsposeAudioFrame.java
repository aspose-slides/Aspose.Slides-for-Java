package com.aspose.slides.examples.asposefeatures.mediacontrols.addaudioframe;
...
public class AsposeAudioFrame
{
    public static void main(String[] args) throws Exception
    {
        ...
        FileInputStream fstr = new FileInputStream(new File(dataDir + "logon.wav"));
        ...
        pres.save(dataDir + "AsposeAudio_Out.pptx", SaveFormat.Pptx);
