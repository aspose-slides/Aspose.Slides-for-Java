...
import static com.aspose.slides.maven.utils.AsposeMavenProjectManager.getAsposeProjectMavenDependencies;
import com.aspose.slides.maven.utils.AsposeSlidesJavaAPI;
import com.aspose.slides.maven.utils.TasksExecutor;
...
@TemplateRegistration(
        ...
        description = "AsposeSlidesMavenDescription.html",
        iconBase = "com/aspose/slides/maven/Aspose.png",
        position = 1,
        content = "AsposeMavenProject.zip")
@Messages("Aspose_displayName=Aspose.Slides Maven Project")
...
public class AsposeMavenProjectWizardIterator implements WizardDescriptor.ProgressInstantiatingIterator<WizardDescriptor> {
    ...
    public Set instantiate(ProgressHandle ph) throws IOException {
        ...
        final AsposeJavaAPI asposeSlidesJavaAPI = AsposeSlidesJavaAPI.initialize(asposeMavenProjectManager);

        boolean isDownloadExamplesSelected = (boolean) wiz.getProperty("downloadExamples");

        // Downloading Aspose.Slides Java (mvn based) examples...
        if (isDownloadExamplesSelected) {
            ...
            tasksExecutionDownloadExamples.addNewTask(asposeMavenProjectManager.createDownloadExamplesTask(asposeSlidesJavaAPI));
            // Execute the tasks
        ...
        // Retrieving Aspose.Slides Java Maven artifact...
        tasksExecutionRetrieve.addNewTask(asposeMavenProjectManager.retrieveAsposeAPIMavenTask(asposeSlidesJavaAPI));
                ...
                if (entry.isDirectory()) {
                    ...
                    if (AsposeConstants.MAVEN_POM_XML.equals(entry.getName())) {
                        /*
                         ...
                         2. Adding latest Aspose.Slides Maven Dependency reference into pom.xml
                         */
